...
results.write('{:50s}{:50s}\n'.format("Sim. Inf. rdy_org", ", ".join(inf_rdy_org)))
results.write('\n{:50s}{:50s}\n'.format("Sim. Sup. rdn_org", ", ".join(sup_rdn_org)))
results.write('{:50s}{:50s}\n'.format("Sim. Inf. rdn_org", ", ".join(inf_rdn_org)))
...
print("[rdy] Sim. Inf(<=5). rdy_org: {}".format(", ".join(inf_rdy_org)))
print("[rdn] Sim. Sup. rdn_org: {}".format(", ".join(sup_rdn_org)))
print("[rdn] Sim. Inf(<=5). rdn_org: {}".format(", ".join(inf_rdn_org)))
